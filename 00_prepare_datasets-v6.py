...
DATASETS = OrderedDict([
 ...
 ("CIC17", r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2017\CSVs\TrafficLabelling"),

 # CIC-IDS-2018: each day/file is prepared separately.
 ("CIC18_TUESDAY",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Tues-20-02-2018.csv"),
 ("CIC18_WEDNESDAY-1",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Wed-14-02-2018.csv"),
 ("CIC18_WEDNESDAY-2",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Wed-21-02-2018.csv"),
 ("CIC18_WEDNESDAY-3",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Wed-28-02-2018.csv"),
 ("CIC18_THURSDAY-1",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Thur-15-02-2018.csv"),
 ("CIC18_THURSDAY-2",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Thur-22-02-2018.csv"),
 ("CIC18_THURSDAY-3",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Thur-01-03-2018.csv"),
 ("CIC18_FRIDAY-1",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Fri-16-02-2018.csv"),
 ("CIC18_FRIDAY-2",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Fri-23-02-2018.csv"),
 ("CIC18_FRIDAY-3",
  r"H:\My Drive\0.RPL-LJ\ALTERNATE IDE JUDUL\CIC-IDS2018\DAYS\Fri-02-03-2018.csv"),
...
def process_one_dataset(name, path):
    ...
    if os.path.isdir(path):
        ...
        for f in files:
            print(f"    Reading: {f}")
            # Tambahkan encoding='latin1' untuk mengabaikan karakter aneh di CIC17
            dfs.append(pd.read_csv(os.path.join(path, f), low_memory=False, encoding='latin1', on_bad_lines='skip'))
        df = pd.concat(dfs, ignore_index=True)
        print(f"    Loaded {len(files)} files.")
    else:
        # Tambahkan encoding dan gunakan engine 'pyarrow' (jika ada) untuk manajemen memori CSV raksasa
        try:
            df = pd.read_csv(path, low_memory=False, encoding='latin1', engine='pyarrow', on_bad_lines='skip')
        except ValueError:
            # Fallback jika library pyarrow belum terinstal
            df = pd.read_csv(path, low_memory=False, encoding='latin1', on_bad_lines='skip')
    n_raw = len(df)
